...
namespace ValorantDatabase.Migrations
{
    ...
    [Migration("20200902133742_AddedRankAdjustments")]
    partial class AddedRankAdjustments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ValorantDatabase.GameLogs", b =>
                {
                    ...
                    b.Property<int?>("RankAdjustmentID")
                        .HasColumnName("RankAdjustmentID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ValorantDatabase.RankAdjustments", b =>
                {
            ...
            modelBuilder.Entity("ValorantDatabase.GameLogs", b =>
                {
                    ...
                    b.HasOne("ValorantDatabase.RankAdjustments", "RankAdjustment")
                        .WithMany("GameLogs")
                        .HasForeignKey("RankAdjustmentID")
